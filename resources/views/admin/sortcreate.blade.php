    ...
    <form class="layui-form" action="/admin/allsort/shore" method="get">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline int">
                <input type="text" name="fenlei_name" id="name" lay-verify="required" placeholder="请输入" autocomplete="off"
                    class="layui-input">
            </div>
        </div>

        <div class="layui-input-block">
            <input type="checkbox" name="sort[1]" value="1" title="网站1">
            <input type="checkbox" name="sort[2]" value="2" title="网站2" checked="">
